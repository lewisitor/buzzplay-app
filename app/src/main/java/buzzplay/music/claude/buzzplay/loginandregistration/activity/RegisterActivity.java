package buzzplay.music.claude.buzzplay.loginandregistration.activity;
...
import buzzplay.music.claude.buzzplay.loginandregistration.app.AppConfig;
import buzzplay.music.claude.buzzplay.loginandregistration.app.AppController;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String firstname = inputFullName.getText().toString().trim();
